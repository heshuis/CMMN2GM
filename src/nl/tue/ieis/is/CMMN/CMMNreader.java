...
public class CMMNreader {
	  	...
	  	public static void parse(Element el,Stage local, CaseSchema cs,Namespace ns){
	  		...
	  		if (name.equals("caseTask")||name.equals("decisionTask")||name.equals("humanTask")||name.equals("processTask")||name.equals("task")){
	  		...
	  		if (name.equals("eventListener")||name.equals("userEventListener")||name.equals("timerEventListener")){
